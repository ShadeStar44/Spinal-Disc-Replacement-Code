...
%% Get Data AP Phys No Tether (Model 10) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_APPhys_NoTether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta AP Phys No Tether (Model 10)')
