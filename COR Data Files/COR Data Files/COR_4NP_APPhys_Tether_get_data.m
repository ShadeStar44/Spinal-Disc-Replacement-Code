...
%% Get Data AP Phys Tether (Model 9) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_APPhys_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta AP Phys Tether (Model 9)')
