...
%% Plot Data AP Phys Tether (Model 9) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_APPhys_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_9','Sheet1');
afound6=xlsread('dperp_9', 'Sheet2');
Dperp_5=xlsread('dperp_9','Sheet3');
afound5=xlsread('dperp_9', 'Sheet4');
Dperp_4=xlsread('dperp_9','Sheet5');
afound4=xlsread('dperp_9', 'Sheet6');
...
xlim([-20 20])
ylim([-45 -35])
title('COR AP Phys Tether (Model 9)')
