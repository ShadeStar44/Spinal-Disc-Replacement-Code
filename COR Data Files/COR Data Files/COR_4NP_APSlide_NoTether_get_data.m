...
%% Get Data AP Slide No Tether (Model 4) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_APSlide_NoTether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta AP Slide No Tether (Model 45)')
