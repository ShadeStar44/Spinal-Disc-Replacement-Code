...
%% Plot Data AP Slide No Tether (Model 4) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_APSlide_NoTether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_4','Sheet1');
afound6=xlsread('dperp_4', 'Sheet2');
Dperp_5=xlsread('dperp_4','Sheet3');
afound5=xlsread('dperp_4', 'Sheet4');
Dperp_4=xlsread('dperp_4','Sheet5');
afound4=xlsread('dperp_4', 'Sheet6');
