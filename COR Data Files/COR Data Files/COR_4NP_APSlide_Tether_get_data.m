...
%% Get Data AP Slide Tether (Model 3) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_APSlide_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta AP Slide Tether (Model 3)')
