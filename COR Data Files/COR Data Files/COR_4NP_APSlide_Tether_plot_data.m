...
%% Plot Data AP Slide Tether (Model 3) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_APSlide_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_3','Sheet1');
afound6=xlsread('dperp_3', 'Sheet2');
Dperp_5=xlsread('dperp_3','Sheet3');
afound5=xlsread('dperp_3', 'Sheet4');
Dperp_4=xlsread('dperp_3','Sheet5');
afound4=xlsread('dperp_3', 'Sheet6');
...
xlim([-20 20])
ylim([-45 -35])
title('COR AP Slide Tether (Model 3)')
