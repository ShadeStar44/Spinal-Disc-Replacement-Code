...
%% Get Data Fixed No Tether (Model 14) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_Fixed_NoTether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Fixed No Tether (Model 14)')
