...
%% Plot Data Fixed No Tether (Model 14) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_Fixed_NoTether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_14','Sheet1');
afound6=xlsread('dperp_14', 'Sheet2');
Dperp_5=xlsread('dperp_14','Sheet3');
afound5=xlsread('dperp_14', 'Sheet4');
Dperp_4=xlsread('dperp_14','Sheet5');
afound4=xlsread('dperp_14', 'Sheet6');
...
xlabel('Y')
ylabel('Z')
title('COR Fixed No Tether (Model 14)')
