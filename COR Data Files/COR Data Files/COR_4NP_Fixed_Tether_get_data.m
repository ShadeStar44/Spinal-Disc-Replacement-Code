...
%% Get Data Fixed Tether (Model 13) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_Fixed_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Fixed Tether (Model 13)')
