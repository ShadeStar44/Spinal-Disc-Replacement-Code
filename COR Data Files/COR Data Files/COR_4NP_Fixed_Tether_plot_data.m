...
%% Plot Data Fixed Tether (Model 13) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_Fixed_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_13','Sheet1');
afound6=xlsread('dperp_13', 'Sheet2');
Dperp_5=xlsread('dperp_13','Sheet3');
afound5=xlsread('dperp_13', 'Sheet4');
Dperp_4=xlsread('dperp_13','Sheet5');
afound4=xlsread('dperp_13', 'Sheet6');
...
xlabel('Y')
ylabel('Z')
title('COR Fixed Tether (Model 13)')
