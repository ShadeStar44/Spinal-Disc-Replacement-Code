...
%% Get Data Lat Phys No Tether (Model 12) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_LatPhys_NoTether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Lat Phys No Tether (Model 12)')
