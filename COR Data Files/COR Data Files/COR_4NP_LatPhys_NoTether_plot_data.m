...
%% Plot Data Lat Phys No Tether (Model 12) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_LatPhys_NoTether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_12','Sheet1');
afound6=xlsread('dperp_12', 'Sheet2');
Dperp_5=xlsread('dperp_12','Sheet3');
afound5=xlsread('dperp_12', 'Sheet4');
Dperp_4=xlsread('dperp_12','Sheet5');
afound4=xlsread('dperp_12', 'Sheet6');
...
figure(3)
plot(axis(2,1:42),axis(3,1:42),'r.-','markersize',10)
xlabel('Y')
ylabel('Z')
title('COR Lat Phys No Tether (Model 12)')
legend('C5 4N axis points','location','north')
xlim([-20 20])
ylim([-45 -35])
hold off
...
xlim([-6 15])
ylim([-43 -37])
legend('C5 4P axis points','location','north')
hold off
...
ylabel('Z')
title('COR Lat Phys No Tether (Model 12)')
legend('C4 4N axis points','location','north')
xlim([-30 25])
ylim([-80 40])
hold off
...
xlim([-20 23])
ylim([-70 -52])
legend('C4 4P axis points','location','north')
hold off