...
%% Get Data Lat Phys Tether (Model 11) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_LatPhys_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Lat Phys Tether (Model 11)')
