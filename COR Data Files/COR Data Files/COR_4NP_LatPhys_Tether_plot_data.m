...
%% Plot Data Lat Phys Tether (Model 11) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_LatPhys_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_11','Sheet1');
afound6=xlsread('dperp_11', 'Sheet2');
Dperp_5=xlsread('dperp_11','Sheet3');
afound5=xlsread('dperp_11', 'Sheet4');
Dperp_4=xlsread('dperp_11','Sheet5');
afound4=xlsread('dperp_11', 'Sheet6');
...
xlabel('Y')
ylabel('Z')
title('COR Lat Phys Tether (Model 11)')
