...
%% Plot Data Lat Slide No Tether (Model 6) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_LatSlide_NoTether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_6','Sheet1');
afound6=xlsread('dperp_6', 'Sheet2');
Dperp_5=xlsread('dperp_6','Sheet3');
afound5=xlsread('dperp_6', 'Sheet4');
Dperp_4=xlsread('dperp_6','Sheet5');
afound4=xlsread('dperp_6', 'Sheet6');
