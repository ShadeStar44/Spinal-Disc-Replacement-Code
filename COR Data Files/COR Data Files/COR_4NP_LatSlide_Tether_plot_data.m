...
%% Plot Data Lat Slide Tether (Model 5) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_LatSlide_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_5','Sheet1');
afound6=xlsread('dperp_5', 'Sheet2');
Dperp_5=xlsread('dperp_5','Sheet3');
afound5=xlsread('dperp_5', 'Sheet4');
Dperp_4=xlsread('dperp_5','Sheet5');
afound4=xlsread('dperp_5', 'Sheet6');
