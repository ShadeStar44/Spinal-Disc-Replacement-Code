...
%% Plot Data Phys Phys No Tether (Model 8) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_PhysPhys_Tether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_8','Sheet1');
afound6=xlsread('dperp_8', 'Sheet2');
Dperp_5=xlsread('dperp_8','Sheet3');
afound5=xlsread('dperp_8', 'Sheet4');
Dperp_4=xlsread('dperp_8','Sheet5');
afound4=xlsread('dperp_8', 'Sheet6');
...
xlim([-20 20])
ylim([-45 -35])
title('COR Phys Phys No Tether (Model 8)')
