...
%% Get Data Phys Phys Tether (Model 7) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_PhysPhys_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Phys Phys Tether (Model 7)')
