...
%% Plot Data Phys Phys Tether (Model 7) 
...
Dperp_6=xlsread('dperp_7','Sheet1');
afound6=xlsread('dperp_7', 'Sheet2');
Dperp_5=xlsread('dperp_7','Sheet3');
afound5=xlsread('dperp_7', 'Sheet4');
Dperp_4=xlsread('dperp_7','Sheet5');
afound4=xlsread('dperp_7', 'Sheet6');
...
xlim([-20 20])
ylim([-45 -35])
title('COR Phys Phys Tether (Model 7)')
