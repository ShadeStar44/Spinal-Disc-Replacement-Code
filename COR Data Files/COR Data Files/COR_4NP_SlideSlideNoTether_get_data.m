...
%% Get Data Slide Slide No Tether (Model 2) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_SlideSlide_NoTether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Slide Slide No Tether (Model 2)')
