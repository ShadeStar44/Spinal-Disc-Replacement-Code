...
%% Plot Data Slide Slide No Tether (Model 2) 

axis=zeros(3,21); 
Dperp_vec=zeros(3,21);
Data = xlsread('COR_4NP_SlideSlide_NoTether');

% pulling the previous dperp and afound data from the file. 
Dperp_6=xlsread('dperp_2','Sheet1');
afound6=xlsread('dperp_2', 'Sheet2');
Dperp_5=xlsread('dperp_2','Sheet3');
afound5=xlsread('dperp_2', 'Sheet4');
Dperp_4=xlsread('dperp_2','Sheet5');
afound4=xlsread('dperp_2', 'Sheet6');
...
xlim([-20 20])
ylim([-45 -35])
title('COR Slide Slide No Tether (Model 2)')
legend('C5 4N axis points','location','northeast')
hold off
...
xlim([-6 15])
ylim([-43 -37])
legend('C5 4P axis points','location','northeast')
hold off
...
ylim([-80 40])
title('COR Slide Slide No Tether (Model 2)')
legend('C4 4N axis points','location','northeast')
hold off
...
xlim([-20 23])
ylim([-70 -52])
legend('C4 4P axis points','location','northeast')
hold off