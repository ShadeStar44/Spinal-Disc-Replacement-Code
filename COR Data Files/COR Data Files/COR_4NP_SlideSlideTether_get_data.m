...
%% Get Data Slide Slide Tether (Model 1) 
...
axis=zeros(3,21); 
Data = xlsread('COR_4NP_SlideSlide_Tether'); %getting all data for the three directions
...
xlabel('Moment')
ylabel('Theta')
title('Theta Slide Slide Tether (Model 15)')
