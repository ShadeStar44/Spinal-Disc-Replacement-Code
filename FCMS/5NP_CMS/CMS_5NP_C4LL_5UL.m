...
% importing data for each model for the 5NP CMS (CFNM/CAREA)
Data = xlsread('5NP_FacetContactMeanStress');

% Getting the columns for the C4LL/5UL facets 
...
xlabel('Moment (Nm)')
ylabel('MPa')
title({'Facet Contact Mean Stress for C4LL/5UL','under Lateral Bending(5P/5N)'})
legend('Model 1','Model 2','Model 3','Model 4','Model 5','Model 6','Model 7','Model 8','Model 9', 'Model 10','Model 11','Model 12','Model 13','Model 14', 'Model 15','location','southeast')