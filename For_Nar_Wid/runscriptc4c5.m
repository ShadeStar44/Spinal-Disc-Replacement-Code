...
suptitle('Left Hand C4-C5 Foramen Percent Change Under Axial Rotation')
% % % % % % % % % % % % % % % % %
figure(8)
plot((t15-2)*(2),-1*height15,'b')
hold on
...
suptitle('Left Hand C4-C5 Foramen Percent Change Under Lateral Bending')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
run('foreman5n_c4c5R.m')
figure(7)
subplot(1,2,1)
pc15x=mag15x(21)/mag15x(1)*100-100;
pc15y=mag15y(21)/mag15y(1)*100-100;
...
legend('Height','Width','location','northwest')
title('Left Lateral Bending')
suptitle('Right Hand C4-C5 Foramen Percent Change Lateral Bending')
...
legend('Height','Width','location','northwest')
title('Left Axial Rotation')
suptitle('Right Hand C4-C5 Foreman Percent Change Under Axial Rotation')
...
xlabel('Moment (N-m)')
ylabel({'Narrowing/Widening (mm)';'(Positive is Widening, Negative is Narrowing)'})
suptitle('C4-C5 Left Hand Foreman Height Narrowing/Widening Under 2 N-m of flexion')
...
xlabel('Moment (N-m)')
ylabel({'Narrowing/Widening (mm)';'(Positive is Widening, Negative is Narrowing)'})
suptitle('C4-C5 Left Hand Foreman Width Narrowing/Widening Under 2 N-m of flexion')
...
ylabel('Percent Change')
legend('Height','Width','location','northwest')
suptitle('C4-C5 Left Hand Foraminal Percent Change Under Extension/Flexion')
title('Flexion')


%%
run('foreman4p_c4c5R.m')
figure(32)
plot((t15-2)*(2),-1*height15,'b')
hold on
plot((t1-2)*(2),-1*height1,'r')
...
xlabel('Moment (N-m)')
ylabel({'Narrowing/Widening (mm)';'(Positive is Widening, Negative is Narrowing)'})
suptitle('C4-C5 Right Hand Foreman Height Narrowing/Widening Under 2 N-m of flexion (4n/4p)')
legend('intact height','model 1 height','model 2 height','model 3 height','model 4 height','model 5 height','model 6 height','model 13 height','model 14 height','location','best')
title('Flexion')
...
xlabel('Moment (N-m)')
ylabel({'Narrowing/Widening (mm)';'(Positive is Widening, Negative is Narrowing)'})
suptitle('C4-C5 Right Hand Foreman Width Narrowing/Widening Under 2 N-m of flexion')
legend('intact width', 'model 1 width','model 2 width', 'model 3 width','model 4 width','model 5 width','model 6 width','model 13 width','model 14 width','location','best')
...
xticklabels({'intact','Lateral Slide','ProDisc-C'})
% xticklabels({'Intact','Model 1','Model 2', 'Model 3','Model 4','Model 5','Model 6','Model 13','model 14'})
suptitle('C4-C5 Right Hand Foraminal Percent Change Under Extension/Flexion')
ylabel('Percent Change')
%%
close(figure(1))
close(figure(2))
