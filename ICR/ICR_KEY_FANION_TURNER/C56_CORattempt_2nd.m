%% Perpendicular Bisect Method Attempt for C5-6 with different nodes
% Christopher Key
% 08/20/2020
...
k = 21;
% Import data 
data = xlsread('CORattempt_C56_2nd.xlsx');
% Posterior Superior Origin node: 76775
oy=4.48301e+02; oz =  -7.30804e+02;
% Anterior Node : 48389
ay = data(1,3)+data(1:21,10)-oy;
az = data(1,4)+data(1:21,11)-oz;
% Posterior Node: 49853
