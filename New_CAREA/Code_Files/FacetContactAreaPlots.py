...
def RMSE(model1, model2, motion):
    ...
    for left, right in facet_pairs:
        if left.startswith('3'): #if C34 disc values, plot data on left and right plot
            ...
            leftyn3 = data_n_1[left]["CAREA"]
            leftyp3 = data_p_1[left]["CAREA"]
            rightyn3 = data_n_1[right]["CAREA"]
            rightyp3 = data_p_1[right]["CAREA"]

            leftyn4 = data_n_2[left]["CAREA"]
            leftyp4 = data_p_2[left]["CAREA"]
            rightyn4 = data_n_2[right]["CAREA"]
            rightyp4 = data_p_2[right]["CAREA"]

            
        elif left.startswith('5'): #If C56 disc values, plot data on left and right plot
            leftyn5 = data_n_1[left]["CAREA"]
            leftyp5 = data_p_1[left]["CAREA"]
            rightyn5 = data_n_1[right]["CAREA"]
            rightyp5 = data_p_1[right]["CAREA"]

            leftyn6 = data_n_2[left]["CAREA"]
            leftyp6 = data_p_2[left]["CAREA"]
            rightyn6 = data_n_2[right]["CAREA"]
            rightyp6 = data_p_2[right]["CAREA"]
...
C34_left, C34_right, C45_left, C45_right, C56_left, C56_right = RMSE('Intact', 'SlideSlideTether', '6N-6P')
print(C34_left, C34_right, C45_left, C45_right, C56_left, C56_right)