...
def read_file34_15(model):
    ...
    orig_coords = {}
    for i, label in enumerate(node_labels):
        cols = df_all.iloc[3, i*4: (i+1) *4]
        orig_coords[label] = {
            "x_val": float(cols.iloc[1]),
            "z_val": float(cols.iloc[2])
        }
    ...
    for i, label in enumerate(node_labels):
        cols = df_all.iloc[3, i*4: (i+1) *4]
        orig_coords[label]["y_val"] = float(cols.iloc[1])
    print('Orig Coords:', orig_coords)
...
def fcor_slice(y_n_left, y_p_left, z_n_left, z_p_left,
    ...
    # Create symmetric weights centered in the window
    x2 = np.linspace(-1, 1, n)
    sigma = 0.3   # smaller = stronger de-weighting of edges

    weights = np.exp(-0.5 * (x2 / sigma)**2)
    weights /= weights.sum()
...
def calculate_FCOR_4n4p(data_n, data_p):
    ...
    y_n_left = data_n[ 29005]["y_vals"]
    y_p_left = data_p[ 29005]["y_vals"]
    z_n_left = data_n[ 29005]["z_vals"]
    z_p_left = data_p[ 29005]["z_vals"]

    y_n_right = data_n[ 49903]["y_vals"]
    y_p_right = data_p[ 49903]["y_vals"]
    z_n_right = data_n[ 49903]["z_vals"]
    z_p_right = data_p[ 49903]["z_vals"]
    ...
    step = split // 2
    for start in range(0, N - split + 1, step):
        #start index at desired spot
...
def calculate_FCOR_5n5p(data_n, data_p):
    ...
    x_n_left = data_n[ 29005]["x_vals"]
    x_p_left = data_p[ 29005]["x_vals"]
    z_n_left = data_n[ 29005]["z_vals"]
    z_p_left = data_p[ 29005]["z_vals"]

    x_n_right = data_n[ 49903]["x_vals"]
    x_p_right = data_p[ 49903]["x_vals"]
    z_n_right = data_n[ 49903]["z_vals"]
    z_p_right = data_p[ 49903]["z_vals"]
...
print("Scale Values: ", scale12_5)
print("Angle vals (deg): ", np.rad2deg(theta12_5))
...
data_4n5, data_4p5, data_5n5, data_5p5= read_file34_5("5")
...
fig14_4.canvas.manager.set_window_title('Model 14 C34 4n/4p')
...
data_4n2, data_4p2, data_5n2, data_5p2= read_file34_1("2")
fcr2_4, scale2_4, theta2_4 = calculate_FCOR_4n4p_C34(data_4n2, data_4p2)
fcr2_5, scale2_5, theta2_5 = calculate_FCOR_5n5p_C34(data_5n2, data_5p2)
print("Scale Values: ", scale2_4)
print("Angle vals (deg): ", np.rad2deg(theta2_4))
...
ax2_4.set_ylabel("Y-Axis (mm)")
ax2_4.set_zlabel("Z-Axis (mm)")
ax2_4.set_title("Model 2 C34 4n/4p")
plt.show()
fig2_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 2/C34/Model_2_COR_4N4P_C34.png', dpi = 300)
...
fig2_5 = plt.figure(5,figsize=(10,8))
ax2_5 = fig2_5.add_subplot(111,projection='3d')
fig2_5.canvas.manager.set_window_title('Model 2 C34 5n/5p')
ax2_5.scatter(y_vals,x_vals2_5,z_vals2_5, c = 'r', marker = 'o')
...
ax2_5.set_ylabel("X-Axis (mm)")
ax2_5.set_zlabel("Z-Axis (mm)")
ax2_5.set_title("Model 2 C34 5n/5p")

plt.show()
fig2_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 2/C34/Model_2_COR_5N5P_C34.png', dpi = 300) 

data_4n6, data_4p6, data_5n6, data_5p6= read_file34_1("6")
fcr6_4, scale6_4, theta6_4 = calculate_FCOR_4n4p_C34(data_4n6, data_4p6)
fcr6_5, scale6_5, theta6_5 = calculate_FCOR_5n5p_C34(data_5n6, data_5p6)
print("Scale Values: ", scale6_4)
print("Angle vals (deg): ", np.rad2deg(theta6_4))
...
ax6_4.set_ylabel("Y-Axis (mm)")
ax6_4.set_zlabel("Z-Axis (mm)")
ax6_4.set_title("Model 6 C34 4n/4p")
plt.show()
fig6_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 6/C34/Model_6_COR_4N4P_C34.png', dpi = 300)
...
fig6_5 = plt.figure(5,figsize=(10,8))
ax6_5 = fig6_5.add_subplot(111,projection='3d')
fig6_5.canvas.manager.set_window_title('Model 6 C34 5n/5p')
ax6_5.scatter(y_vals,x_vals6_5,z_vals6_5, c = 'r', marker = 'o')
...
ax6_5.set_ylabel("X-Axis (mm)")
ax6_5.set_zlabel("Z-Axis (mm)")
ax6_5.set_title("Model 6 C34 5n/5p")

plt.show()
fig6_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 6/C34/Model_6_COR_5N5P_C34.png', dpi = 300)

data_4n8, data_4p8, data_5n8, data_5p8= read_file34_15("8")
fcr8_4, scale8_4, theta8_4 = calculate_FCOR_4n4p_C34(data_4n8, data_4p8)
fcr8_5, scale8_5, theta8_5 = calculate_FCOR_5n5p_C34(data_5n8, data_5p8)
print("Scale Values: ", scale8_4)
print("Angle vals (deg): ", np.rad2deg(theta8_4))
...
ax8_4.set_ylabel("Y-Axis (mm)")
ax8_4.set_zlabel("Z-Axis (mm)")
ax8_4.set_title("Model 8 C34 4n/4p")
plt.show()
fig8_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 8/C34/Model_8_COR_4N4P_C34.png', dpi = 300)
...
fig8_5 = plt.figure(5,figsize=(10,8))
ax8_5 = fig8_5.add_subplot(111,projection='3d')
fig8_5.canvas.manager.set_window_title('Model 8 C34 5n/5p')
ax8_5.scatter(y_vals,x_vals8_5,z_vals8_5, c = 'r', marker = 'o')
...
ax8_5.set_ylabel("X-Axis (mm)")
ax8_5.set_zlabel("Z-Axis (mm)")
ax8_5.set_title("Model 8 C34 5n/5p")

plt.show()
fig8_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 8/C34/Model_8_COR_5N5P_C34.png', dpi = 300)

data_4n9, data_4p9, data_5n9, data_5p9= read_file34_15("9")
fcr9_4, scale9_4, theta9_4 = calculate_FCOR_4n4p_C34(data_4n9, data_4p9)
fcr9_5, scale9_5, theta9_5 = calculate_FCOR_5n5p_C34(data_5n9, data_5p9)
print("Scale Values: ", scale9_4)
print("Angle vals (deg): ", np.rad2deg(theta9_4))
...
ax9_4.set_ylabel("Y-Axis (mm)")
ax9_4.set_zlabel("Z-Axis (mm)")
ax9_4.set_title("Model 9 C34 4n/4p")
plt.show()
fig9_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 9/C34/Model_9_COR_4N4P_C34.png', dpi = 300)
...
fig9_5 = plt.figure(5,figsize=(10,8))
ax9_5 = fig9_5.add_subplot(111,projection='3d')
fig9_5.canvas.manager.set_window_title('Model 9 C34 5n/5p')
ax9_5.scatter(y_vals,x_vals9_5,z_vals9_5, c = 'r', marker = 'o')
...
ax9_5.set_ylabel("X-Axis (mm)")
ax9_5.set_zlabel("Z-Axis (mm)")
ax9_5.set_title("Model 9 C34 5n/5p")

plt.show()
fig9_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 9/C34/Model_9_COR_5N5P_C34.png', dpi = 300)

data_4n10, data_4p10, data_5n10, data_5p10= read_file34_15("10")
fcr10_4, scale10_4, theta10_4 = calculate_FCOR_4n4p_C34(data_4n10, data_4p10)
fcr10_5, scale10_5, theta10_5 = calculate_FCOR_5n5p_C34(data_5n10, data_5p10)
print("Scale Values: ", scale10_4)
print("Angle vals (deg): ", np.rad2deg(theta10_4))
...
ax10_4.set_ylabel("Y-Axis (mm)")
ax10_4.set_zlabel("Z-Axis (mm)")
ax10_4.set_title("Model 10 C34 4n/4p")
plt.show()
fig10_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 10/C34/Model_10_COR_4N4P_C34.png', dpi = 300)
...
fig10_5 = plt.figure(5,figsize=(10,8))
ax10_5 = fig10_5.add_subplot(111,projection='3d')
fig10_5.canvas.manager.set_window_title('Model 10 C34 5n/5p')
ax10_5.scatter(y_vals,x_vals10_5,z_vals10_5, c = 'r', marker = 'o')
...
for i in range(len(x_vals10_5)):
    ax10_5.text(
        ...
        x_vals10_5[i], 
        z_vals10_5[i],
        f"{i}({x_vals10_5[i]:.2f}, {y_vals[i]:.2f}, {z_vals10_5[i]:.2f})",
        fontsize=8
    )
...
ax10_5.set_ylabel("X-Axis (mm)")
ax10_5.set_zlabel("Z-Axis (mm)")
ax10_5.set_title("Model 10 C34 5n/5p")

plt.show()
fig10_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 10/C34/Model_10_COR_5N5P_C34.png', dpi = 300)

data_4n11, data_4p11, data_5n11, data_5p11= read_file34_15("11")
fcr11_4, scale11_4, theta11_4 = calculate_FCOR_4n4p_C34(data_4n11, data_4p11)
fcr11_5, scale11_5, theta11_5 = calculate_FCOR_5n5p_C34(data_5n11, data_5p11)
print("Scale Values: ", scale11_4)
print("Angle vals (deg): ", np.rad2deg(theta11_4))
...
ax11_4.set_ylabel("Y-Axis (mm)")
ax11_4.set_zlabel("Z-Axis (mm)")
ax11_4.set_title("Model 11 C34 4n/4p")
plt.show()
fig11_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 11/C34/Model_11_COR_4N4P_C34.png', dpi = 300)
...
fig11_5 = plt.figure(5,figsize=(10,8))
ax11_5 = fig11_5.add_subplot(111,projection='3d')
fig11_5.canvas.manager.set_window_title('Model 11 C34 5n/5p')
ax11_5.scatter(y_vals,x_vals11_5,z_vals11_5, c = 'r', marker = 'o')
...
ax11_5.set_ylabel("X-Axis (mm)")
ax11_5.set_zlabel("Z-Axis (mm)")
ax11_5.set_title("Model 11 C34 5n/5p")

plt.show()
fig11_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 11/C34/Model_11_COR_5N5P_C34.png', dpi = 300)

data_4n12, data_4p12, data_5n12, data_5p12= read_file34_15("12")
fcr12_4, scale12_4, theta12_4 = calculate_FCOR_4n4p_C34(data_4n12, data_4p12)
fcr12_5, scale12_5, theta12_5 = calculate_FCOR_5n5p_C34(data_5n12, data_5p12)
print("Scale Values: ", scale12_4)
print("Angle vals (deg): ", np.rad2deg(theta12_4))
...
ax12_4.set_ylabel("Y-Axis (mm)")
ax12_4.set_zlabel("Z-Axis (mm)")
ax12_4.set_title("Model 12 C34 4n/4p")
plt.show()
fig12_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 12/C34/Model_12_COR_4N4P_C34.png', dpi = 300)
...
fig12_5 = plt.figure(5,figsize=(10,8))
ax12_5 = fig12_5.add_subplot(111,projection='3d')
fig12_5.canvas.manager.set_window_title('Model 12 C34 5n/5p')
ax12_5.scatter(y_vals,x_vals12_5,z_vals12_5, c = 'r', marker = 'o')
...
ax12_5.set_ylabel("X-Axis (mm)")
ax12_5.set_zlabel("Z-Axis (mm)")
ax12_5.set_title("Model 12 C34 5n/5p")

plt.show()
fig12_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 12/C34/Model_12_COR_5N5P_C34.png', dpi = 300)


data_4n13, data_4p13, data_5n13, data_5p13= read_file34_15("13")
fcr13_4, scale13_4, theta13_4 = calculate_FCOR_4n4p_C34(data_4n13, data_4p13)
fcr13_5, scale13_5, theta13_5 = calculate_FCOR_5n5p_C34(data_5n13, data_5p13)
print("Scale Values: ", scale13_4)
print("Angle vals (deg): ", np.rad2deg(theta13_4))
...
ax13_4.set_ylabel("Y-Axis (mm)")
ax13_4.set_zlabel("Z-Axis (mm)")
ax13_4.set_title("Model 13 C34 4n/4p")
plt.show()
fig13_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 13/C34/Model_13_COR_4N4P_C34.png', dpi = 300)
...
fig13_5 = plt.figure(5,figsize=(10,8))
ax13_5 = fig13_5.add_subplot(111,projection='3d')
fig13_5.canvas.manager.set_window_title('Model 13 C34 5n/5p')
ax13_5.scatter(y_vals,x_vals13_5,z_vals13_5, c = 'r', marker = 'o')
...
ax13_5.set_ylabel("X-Axis (mm)")
ax13_5.set_zlabel("Z-Axis (mm)")
ax13_5.set_title("Model 13 C34 5n/5p")

plt.show()
fig13_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 13/C34/Model_13_COR_5N5P_C34.png', dpi = 300)
 """
# --- C56 Plots -------
...
fig3_4 = plt.figure(5,figsize=(10,8))
ax3_4 = fig3_4.add_subplot(111,projection='3d')
fig3_4.canvas.manager.set_window_title('Model 3 C56 4n/4p')
ax3_4.scatter(x_vals,y_vals3_4,z_vals3_4, c = 'r', marker = 'o')
...
fig14_5 = plt.figure(5,figsize=(10,8))
ax14_5 = fig14_5.add_subplot(111,projection='3d')
fig14_5.canvas.manager.set_window_title('Model 14 C56 5n/5p')
ax14_5.scatter(y_vals,x_vals14_5,z_vals14_5, c = 'r', marker = 'o')
...
data_4n2, data_4p2, data_5n2, data_5p2= read_file56_15("2")
fcr2_4, scale2_4, theta2_4 = calculate_FCOR_4n4p_C56(data_4n2, data_4p2)
fcr2_5, scale2_5, theta2_5 = calculate_FCOR_5n5p_C56(data_5n2, data_5p2)
print("Scale Values: ", scale2_4)
print("Angle vals (deg): ", np.rad2deg(theta2_4))
...
fig2_4 = plt.figure(5,figsize=(10,8))
ax2_4 = fig2_4.add_subplot(111,projection='3d')
fig2_4.canvas.manager.set_window_title('Model 2 C56 4n/4p')
ax2_4.scatter(x_vals,y_vals2_4,z_vals2_4, c = 'r', marker = 'o')
...
ax2_4.set_ylabel("Y-Axis (mm)")
ax2_4.set_zlabel("Z-Axis (mm)")
ax2_4.set_title("Model 2 C56 4n/4p")
plt.show()
fig2_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 2/C56/Model_2_COR_4N4P_C56.png', dpi = 300)
...
fig2_5 = plt.figure(5,figsize=(10,8))
ax2_5 = fig2_5.add_subplot(111,projection='3d')
fig2_5.canvas.manager.set_window_title('Model 2 C56 5n/5p')
ax2_5.scatter(y_vals,x_vals2_5,z_vals2_5, c = 'r', marker = 'o')
...
ax2_5.set_ylabel("X-Axis (mm)")
ax2_5.set_zlabel("Z-Axis (mm)")
ax2_5.set_title("Model 2 C56 5n/5p")

plt.show()
fig2_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 2/C56/Model_2_COR_5N5P_C56.png', dpi = 300)

data_4n6, data_4p6, data_5n6, data_5p6= read_file56_15("6")
fcr6_4, scale6_4, theta6_4 = calculate_FCOR_4n4p_C56(data_4n6, data_4p6)
fcr6_5, scale6_5, theta6_5 = calculate_FCOR_5n5p_C56(data_5n6, data_5p6)
print("Scale Values: ", scale6_4)
print("Angle vals (deg): ", np.rad2deg(theta6_4))
...
fig6_4 = plt.figure(5,figsize=(10,8))
ax6_4 = fig6_4.add_subplot(111,projection='3d')
fig6_4.canvas.manager.set_window_title('Model 6 C56 4n/4p')
ax6_4.scatter(x_vals,y_vals6_4,z_vals6_4, c = 'r', marker = 'o')
...
ax6_4.set_ylabel("Y-Axis (mm)")
ax6_4.set_zlabel("Z-Axis (mm)")
ax6_4.set_title("Model 6 C56 4n/4p")
plt.show()
fig6_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 6/C56/Model_6_COR_4N4P_C56.png', dpi = 300)
...
fig6_5 = plt.figure(5,figsize=(10,8))
ax6_5 = fig6_5.add_subplot(111,projection='3d')
fig6_5.canvas.manager.set_window_title('Model 6 C56 5n/5p')
ax6_5.scatter(y_vals,x_vals6_5,z_vals6_5, c = 'r', marker = 'o')
...
ax6_5.set_ylabel("X-Axis (mm)")
ax6_5.set_zlabel("Z-Axis (mm)")
ax6_5.set_title("Model 6 C56 5n/5p")

plt.show()
fig6_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 6/C56/Model_6_COR_5N5P_C56.png', dpi = 300)


data_4n8, data_4p8, data_5n8, data_5p8= read_file56_15("8")
fcr8_4, scale8_4, theta8_4 = calculate_FCOR_4n4p_C56(data_4n8, data_4p8)
fcr8_5, scale8_5, theta8_5 = calculate_FCOR_5n5p_C56(data_5n8, data_5p8)
print("Scale Values: ", scale8_4)
print("Angle vals (deg): ", np.rad2deg(theta8_4))
...
fig8_4 = plt.figure(5,figsize=(10,8))
ax8_4 = fig8_4.add_subplot(111,projection='3d')
fig8_4.canvas.manager.set_window_title('Model 8 C56 4n/4p')
ax8_4.scatter(x_vals,y_vals8_4,z_vals8_4, c = 'r', marker = 'o')
...
ax8_4.set_ylabel("Y-Axis (mm)")
ax8_4.set_zlabel("Z-Axis (mm)")
ax8_4.set_title("Model 8 C56 4n/4p")
plt.show()
fig8_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 8/C56/Model_8_COR_4N4P_C56.png', dpi = 300)
...
fig8_5 = plt.figure(5,figsize=(10,8))
ax8_5 = fig8_5.add_subplot(111,projection='3d')
fig8_5.canvas.manager.set_window_title('Model 8 C56 5n/5p')
ax8_5.scatter(y_vals,x_vals8_5,z_vals8_5, c = 'r', marker = 'o')
...
ax8_5.set_ylabel("X-Axis (mm)")
ax8_5.set_zlabel("Z-Axis (mm)")
ax8_5.set_title("Model 8 C56 5n/5p")

plt.show()
fig8_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 8/C56/Model_8_COR_5N5P_C56.png', dpi = 300)

data_4n9, data_4p9, data_5n9, data_5p9= read_file56_15("9")
fcr9_4, scale9_4, theta9_4 = calculate_FCOR_4n4p_C56(data_4n9, data_4p9)
fcr9_5, scale9_5, theta9_5 = calculate_FCOR_5n5p_C56(data_5n9, data_5p9)
print("Scale Values: ", scale9_4)
print("Angle vals (deg): ", np.rad2deg(theta9_4))
...
fig9_4 = plt.figure(5,figsize=(10,8))
ax9_4 = fig9_4.add_subplot(111,projection='3d')
fig9_4.canvas.manager.set_window_title('Model 9 C56 4n/4p')
ax9_4.scatter(x_vals,y_vals9_4,z_vals9_4, c = 'r', marker = 'o')
...
ax9_4.set_ylabel("Y-Axis (mm)")
ax9_4.set_zlabel("Z-Axis (mm)")
ax9_4.set_title("Model 9 C56 4n/4p")
plt.show()
fig9_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 9/C56/Model_9_COR_4N4P_C56.png', dpi = 300)
...
fig9_5 = plt.figure(5,figsize=(10,8))
ax9_5 = fig9_5.add_subplot(111,projection='3d')
fig9_5.canvas.manager.set_window_title('Model 9 C56 5n/5p')
ax9_5.scatter(y_vals,x_vals9_5,z_vals9_5, c = 'r', marker = 'o')
...
ax9_5.set_ylabel("X-Axis (mm)")
ax9_5.set_zlabel("Z-Axis (mm)")
ax9_5.set_title("Model 9 C56 5n/5p")

plt.show()
fig9_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 9/C56/Model_9_COR_5N5P_C56.png', dpi = 300)


""" data_4n10, data_4p10, data_5n10, data_5p10= read_file56_15("10")
fcr10_4, scale10_4, theta10_4 = calculate_FCOR_4n4p_C56(data_4n10, data_4p10)
fcr10_5, scale10_5, theta10_5 = calculate_FCOR_5n5p_C56(data_5n10, data_5p10)
print("Scale Values: ", scale10_4)
print("Angle vals (deg): ", np.rad2deg(theta10_4))
...
fig10_4 = plt.figure(5,figsize=(10,8))
ax10_4 = fig10_4.add_subplot(111,projection='3d')
fig10_4.canvas.manager.set_window_title('Model 10 C56 4n/4p')
ax10_4.scatter(x_vals,y_vals10_4,z_vals10_4, c = 'r', marker = 'o')
...
ax10_4.set_ylabel("Y-Axis (mm)")
ax10_4.set_zlabel("Z-Axis (mm)")
ax10_4.set_title("Model 10 C56 4n/4p")
plt.show()
fig10_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 10/C56/Model_10_COR_4N4P_C56.png', dpi = 300)
...
fig10_5 = plt.figure(5,figsize=(10,8))
ax10_5 = fig10_5.add_subplot(111,projection='3d')
fig10_5.canvas.manager.set_window_title('Model 10 C56 5n/5p')
ax10_5.scatter(y_vals,x_vals10_5,z_vals10_5, c = 'r', marker = 'o')
...
ax10_5.set_ylabel("X-Axis (mm)")
ax10_5.set_zlabel("Z-Axis (mm)")
ax10_5.set_title("Model 10 C56 5n/5p")

plt.show()
fig10_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 10/C56/Model_10_COR_5N5P_C56.png', dpi = 300)
 """

data_4n11, data_4p11, data_5n11, data_5p11= read_file56_15("11")
fcr11_4, scale11_4, theta11_4 = calculate_FCOR_4n4p_C56(data_4n11, data_4p11)
fcr11_5, scale11_5, theta11_5 = calculate_FCOR_5n5p_C56(data_5n11, data_5p11)
print("Scale Values: ", scale11_4)
print("Angle vals (deg): ", np.rad2deg(theta11_4))
...
fig11_4 = plt.figure(5,figsize=(10,8))
ax11_4 = fig11_4.add_subplot(111,projection='3d')
fig11_4.canvas.manager.set_window_title('Model 11 C56 4n/4p')
ax11_4.scatter(x_vals,y_vals11_4,z_vals11_4, c = 'r', marker = 'o')
...
ax11_4.set_ylabel("Y-Axis (mm)")
ax11_4.set_zlabel("Z-Axis (mm)")
ax11_4.set_title("Model 11 C56 4n/4p")
plt.show()
fig11_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 11/C56/Model_11_COR_4N4P_C56.png', dpi = 300)
...
fig11_5 = plt.figure(5,figsize=(10,8))
ax11_5 = fig11_5.add_subplot(111,projection='3d')
fig11_5.canvas.manager.set_window_title('Model 11 C56 5n/5p')
ax11_5.scatter(y_vals,x_vals11_5,z_vals11_5, c = 'r', marker = 'o')
...
ax11_5.set_ylabel("X-Axis (mm)")
ax11_5.set_zlabel("Z-Axis (mm)")
ax11_5.set_title("Model 11 C56 5n/5p")

plt.show()
fig11_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 11/C56/Model_11_COR_5N5P_C56.png', dpi = 300)


data_4n12, data_4p12, data_5n12, data_5p12= read_file56_15("12")
fcr12_4, scale12_4, theta12_4 = calculate_FCOR_4n4p_C56(data_4n12, data_4p12)
fcr12_5, scale12_5, theta12_5 = calculate_FCOR_5n5p_C56(data_5n12, data_5p12)
print("Scale Values: ", scale12_4)
print("Angle vals (deg): ", np.rad2deg(theta12_4))
...
fig12_4 = plt.figure(5,figsize=(10,8))
ax12_4 = fig12_4.add_subplot(111,projection='3d')
fig12_4.canvas.manager.set_window_title('Model 12 C56 4n/4p')
ax12_4.scatter(x_vals,y_vals12_4,z_vals12_4, c = 'r', marker = 'o')
...
ax12_4.set_ylabel("Y-Axis (mm)")
ax12_4.set_zlabel("Z-Axis (mm)")
ax12_4.set_title("Model 12 C56 4n/4p")
plt.show()
fig12_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 12/C56/Model_12_COR_4N4P_C56.png', dpi = 300)
...
fig12_5 = plt.figure(5,figsize=(10,8))
ax12_5 = fig12_5.add_subplot(111,projection='3d')
fig12_5.canvas.manager.set_window_title('Model 12 C56 5n/5p')
ax12_5.scatter(y_vals,x_vals12_5,z_vals12_5, c = 'r', marker = 'o')
...
ax12_5.set_ylabel("X-Axis (mm)")
ax12_5.set_zlabel("Z-Axis (mm)")
ax12_5.set_title("Model 12 C56 5n/5p")

plt.show()
fig12_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 12/C56/Model_12_COR_5N5P_C56.png', dpi = 300)


data_4n13, data_4p13, data_5n13, data_5p13= read_file56_15("13")
fcr13_4, scale13_4, theta13_4 = calculate_FCOR_4n4p_C56(data_4n13, data_4p13)
fcr13_5, scale13_5, theta13_5 = calculate_FCOR_5n5p_C56(data_5n13, data_5p13)
print("Scale Values: ", scale13_4)
print("Angle vals (deg): ", np.rad2deg(theta13_4))
...
fig13_4 = plt.figure(5,figsize=(10,8))
ax13_4 = fig13_4.add_subplot(111,projection='3d')
fig13_4.canvas.manager.set_window_title('Model 13 C56 4n/4p')
ax13_4.scatter(x_vals,y_vals13_4,z_vals13_4, c = 'r', marker = 'o')
...
ax13_4.set_ylabel("Y-Axis (mm)")
ax13_4.set_zlabel("Z-Axis (mm)")
ax13_4.set_title("Model 13 C56 4n/4p")
plt.show()
fig13_4.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 13/C56/Model_13_COR_4N4P_C56.png', dpi = 300)
...
fig13_5 = plt.figure(5,figsize=(10,8))
ax13_5 = fig13_5.add_subplot(111,projection='3d')
fig13_5.canvas.manager.set_window_title('Model 13 C56 5n/5p')
ax13_5.scatter(y_vals,x_vals13_5,z_vals13_5, c = 'r', marker = 'o')
...
ax13_5.set_ylabel("X-Axis (mm)")
ax13_5.set_zlabel("Z-Axis (mm)")
ax13_5.set_title("Model 13 C56 5n/5p")

plt.show()
fig13_5.savefig('New_CenterOfRotation/Finite_COR/Plots/Model 13/C56/Model_13_COR_5N5P_C56.png', dpi = 300)