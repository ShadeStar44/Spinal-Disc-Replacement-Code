...
xlabel('Moment (N-m)')
ylabel('Degrees')
yticks([-60,-55,-50,-45,-40,-35,-30,-25,-20,-15,-10,-5,0,5,10,15,20,25,30,35,40,45,50,55,60])
...
yuN1=8.01;
yu1=8.48;
PC=[bb1;bb2;bb3;yu1;yuN1;patel1;patelN1];
b=bar(PC,'FaceColor','flat');
xticklabels({'intact','model 4','model 14','Prestige LP','Yu''s Normal','ProDisc-C','Patel''s intact'})
...
yuN2=5.78;
yu2=6.46;
PC=[ba1,ba2,ba3,yu2,yuN2,patel2,patelN2];
bar(PC)
xticklabels({'intact','model 4','model 14','Prestige LP','Yu''s Normal','ProDisc-C','Patel''s Normal'})
ylabel('Degree')
...
yu3=5.7;
yuN3=5.32;
PC=[bc1,bc2,bc3,yu3,yuN3,patel3,patelN3];
bar(PC)
xticklabels({'intact','model 4','model 14','Prestige LP','Yu''s Normal','ProDisc-C','Patel''s Normal'})
ylabel('Degree')
